...
\begin{itemize}
   ...
   \item[(5)] 
      \begin{enumerate}
         \item Notice that $\int|f\overline{g}|d\mu\leq\frac{1}{2}\int(|f|^2+|g|^2)d\mu \leq \frac{1}{2}\int|f|^2d\mu +\frac{1}{2}\int|g|^2d\mu <\infty$ 
         ...
         \item Cauchy-Schwarz tells us $|\int f\overline g d\mu|=|\ip{f,g}|\leq\norm{f}_2\norm{g}_2$ and because $
      \end{enumerate}
\end{itemize}
