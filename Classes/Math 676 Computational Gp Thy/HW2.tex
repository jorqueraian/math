...
\begin{itemize}
   ...
   \begin{enumerate}[label= (\alph*)]
      ...
      \item $\Rightarrow$) Let $\phi:\underbar{g}\ra H$ extends to a homomorphism $\phi:G\ra H$
            ...
            This means that $w^a=w$ for all $w\in\Omega_G$ and so $a=1$ because $G$ being a permutation group and so it acts faithfully on $\Omega_G$.% this may not be true? I think this really means a is in the kernel of the action
