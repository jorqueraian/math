...
\begin{itemize}
   \item[1.]
      ...
      %$2^{m-1}x$ and $2^{m-1}(x+h_m)$ have the same closest integer. This is always possible as  $|2^{m-1}h_m|=2^{m-1}2^{-m}=\frac{1}{2}$. 
      ...
      %, which follows from the original choice of $h_m$, and 
      %that $2^{m-1}x$ and $2^{m-1}(x+h_m)$ have the same closest integer $n$ and so $2^k2^{m-k-1}x$ and $2^k2^{m-k-1}(x+h_m)$
